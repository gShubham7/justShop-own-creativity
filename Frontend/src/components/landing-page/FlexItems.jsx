    ...
    <Stack className="flexItemsBox" direction={["column", "row"]}>
      {items.map((item) => (
        <Flex key={item.id} className="itemBox">
          <Box className="text">
            <Box>{item.title}</Box>
            <Box style={{ color: "#14244B", fontWeight: "bold" }}>
              {item.head}
            </Box>
          </Box>
          <Box>
      ...
      <Flex className="itemBox" display={{ base: "none", md: "flex" }}>
        ...
        <Box>
          <Image
            src={
              "https://cdn.shopify.com/s/files/1/0057/8938/4802/products/black2_300x.png?v=1654312291"
            }
            width="136px"
          />
        </Box>
      ...
      <Flex key={4} className="itemBox" display={{ base: "none", md: "flex" }}>
        ...
        <Box>
          <Image
            src="https://cdn.shopify.com/s/files/1/0057/8938/4802/products/main1_c1144ee5-d03e-483a-8e5f-7552b138a4b1_300x.png?v=1649857754"
            width="136px"
          />
        </Box>
      </Flex>
